	...
	return (
		<div className="h-1/3 py-5 w-full relative flex flex-col items-center justify-center bg-[#18181b]">
            <div className="border-t border-b py-10 w-[90%] border-white">
                <div className="inline-flex items-center justify-center w-full md:w-fit"><Image src={logo} className="size-14 lg:size-24 " alt="UNIONYX Logo"/> <span className="text-5xl lg:text-8xl font-semibold font-montserrat">UNIONYX</span></div>
            </div>
