...
export default function Footer() {
	return (
		<div className="h-1/3 py-5 w-full relative flex text-white flex-col items-center justify-center bg-[#18181b]">
			<div className="border-t border-b py-10 w-[90%] border-white flex justify-between flex-col lg:flex-row">
				<div className="w-fit flex items-center justify-evenly flex-col">
                ...
                <div className="w-fit flex flex-col items-start gap-3">
                    <h2 className="uppercase mb-5 font-semibold">Company</h2>
                ...
                <div className="w-fit flex flex-col items-start gap-3">
                    <h2 className="uppercase mb-5 font-semibold">Get In Touch</h2>
                    ...
                    <a className="text-slate-100" href="#" rel="noopener noreferrer">D-Block Indirapuram colony Sec-12,<br/> Lucknow(UP), 226001</a>
                </div>
			</div>
